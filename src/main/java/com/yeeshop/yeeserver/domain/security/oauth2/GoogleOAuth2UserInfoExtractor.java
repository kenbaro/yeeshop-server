...
public class GoogleOAuth2UserInfoExtractor  implements OAuth2UserInfoExtractor{
	...
	public CustomUserDetails extractUserInfo(OAuth2User oAuth2User) {
        ...
        customUserDetails.setUsername(retrieveAttr("name", oAuth2User));
        ...
        customUserDetails.setAuthorities(Collections.singletonList(new SimpleGrantedAuthority(YeeCommonConst.YeeRole.USER_ROLE)));
